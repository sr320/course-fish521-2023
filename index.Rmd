...
subtitle: "FISH 521 &nbsp; &nbsp; University of Washington &nbsp; &nbsp; Winter 2023"
output:
  html_document:
    toc: true
    toc_float: true
...
[**Steven Roberts**](https://fish.uw.edu/faculty/mark-scheuerell/)\
Professor, School of Aquatic & Fishery Sciences\
FTR 230 [sr320\@uw.edu](mailto:sr320@uw.edu)
...
[By appointment](https://d.pr/gsgxVJ)
...
Course related communication will predominantly be done on GitHub. Specifically using the [Discussion feature in the assistance repo](https://github.com/course-fish521-2023/assistance/discussions). Any personal communication should be addressed to me via email. Additionally you are welcome to schedule a meeting with me using the following link: <https://d.pr/gsgxVJ>
